...
public:
	...
	bool init()
	{
		...
		if (!soundBuffer1.loadFromFile("assets/cough.ogg"))
			return false;

		if (!soundBuffer2.loadFromFile("assets/nono.ogg"))
			return false;

		if (!soundBuffer3.loadFromFile("assets/puff.ogg"))
			return false;
...
private:
	...
	void setup()
	{
		...
		cough.setBuffer(soundBuffer1);
		nono.setBuffer(soundBuffer2);
		puff.setBuffer(soundBuffer3);
